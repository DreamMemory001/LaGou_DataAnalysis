...
def get_json(url, datas):
    my_headers = {
        ...
        "Referer": "https://www.lagou.com/jobs/list_Pyhton?city=%E5%85%A8%E5%9B%BD&cl=false&fromSearch=true&labelWords=&suginput=",
...
def main():
    ...
    for x in range(1, page + 1):
        ...
        worksheet = workbook.add_sheet('lagou_python', cell_overwrite_ok=True)
        for i, row in enumerate(info_result):
            for j, col in enumerate(row):
                worksheet.write(i, j, col)
        workbook.save('lagou_python.xls')
